...
define("../build_tools/almond", function(){});
	...
	var Class = function(props) {
		...
		if (props.hasOwnProperty) {
			if (props.hasOwnProperty('constructor')) {
				console.warn('\'constructor\' parameter is deprecated, use \'init\' instead');
				props.init = props.constructor;
				delete props.constructor;
			}
		} else {
			console.warn('\'hasOwnProperty\' method not implemented, you should always specify a custom \'init\' parameter');
			props.__init__ = props.init || props.constructor;
		}
		if (props.init) {
			props.__init__ = props.init;
			delete props.init;
		} else if (parent.__init__) {
			props.__init__ = parent.__init__;
		} else {
			props.__init__ = function() {};
		}
		...
		for (k in props) {
			if (typeof props[k] === 'function'
					&& typeof parent[k] === 'function'
					&& /\bsuper\b/.test(props[k])) {
				props[k] = (function(fn, parent, name) {
					return function() {
						this.super = (function(fn) {
							return function() {
		...
		if (props.__name__) {
			newClassProps.toString = _publicProperty(function() {
				return '[' + this.__name__ + ' Object]';
			});
		}
